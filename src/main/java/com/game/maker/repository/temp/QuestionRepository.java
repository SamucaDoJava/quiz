...
public class QuestionRepository {
    ...
    public List<Question> findAll(){
        ...
        // Pergunta 1
        List<QuestionAlternative> alternativesOne = new ArrayList<>();
        ...
        // Pergunta 2
        List<QuestionAlternative> alternativesTwo = new ArrayList<>();
        ...
        // Pergunta 3
        List<QuestionAlternative> alternativesTree = new ArrayList<>();
        ...
        // Pergunta 4
        List<QuestionAlternative> alternativesFour = new ArrayList<>();
        ...
        // Pergunta 5
        List<QuestionAlternative> alternativesFive = new ArrayList<>();
        ...
        // Pergunta 6
        List<QuestionAlternative> alternativesSix = new ArrayList<>();
        ...
        // Pergunta 7
        List<QuestionAlternative> alternativesSeven = new ArrayList<>();
        ...
        // Pergunta 8
        List<QuestionAlternative> alternativesEight = new ArrayList<>();
        ...
        // Pergunta 9
        List<QuestionAlternative> alternativesNine = new ArrayList<>();
        ...
        // Pergunta 10
        List<QuestionAlternative> alternativesTen = new ArrayList<>();
        ...
        // Pergunta 11
        List<QuestionAlternative> alternativesEleven = new ArrayList<>();
        ...
        // Pergunta 12
        List<QuestionAlternative> alternativesTwelve = new ArrayList<>();
