...
public class Alternative {
  ...
  public Alternative(Long id, String referenceLetter, String alternative, Boolean itsCorrect) {
    this(referenceLetter, alternative, itsCorrect);
    this.id = id;
  }

  public Alternative(Long id, String alternative, Boolean itsCorrect, String referenceLetter, Question question) {
    this(id, referenceLetter, alternative, itsCorrect);
